...
import PopupRatings from "../../component/popupRatings";
  ...
  componentWillMount() {
    ...
    init() {
        ...
        if(dataContent) {
            ...
            //convert rating from array
            // console.log(dataContent.ratings);
            // console.log(dataContent.ratings.length);
            // console.log("total",dataContent.ratings.reduce(function(a, b) { return a + b; },0))

            // create array for ratings
            // for(let i = 0; i < dataContent.rate.length ; i++ ){
            //   ratingValue.push(dataContent.rate[i].ratings)
            // }
            ...
            bodyContent =
                <div className="row">
                    ...
                    <div className="col-xs-12 col-md-5 pull-right">
                        <PlayerVid {...this.props} id={idContent} poster={`${config.static}/images/${dataContent.imagePreview}`} source={`${config.static}/api/v1/videos/${dataContent.video}`}  />
                    ...
                    <ul className="breadcrumb">
                        <span className="bread-detail-vid">
                            ...
                            <li className="bread-detail">
                                <div className="">
                                    <span className="rating"><span style={{width: `${countRatings(dataContent.rate) * 20}%`}}></span> </span>
                                </div>
                            </li>
    ...
    render() {
        ...
        // console.log("from detail page", this.props.popup);
            ...
            <div>
                ...
                <section className="section-padding">
                    <div className="container">
                        <div className="row">
                            <BreadCrumb {...this.props} catlink={this.props.match.params.categoryName} catname={categoryName} cattitle={this.props.courses.data.content.title}/>
                        </div>
                        {headContent}
                        {bodyContent}
                ...
                <Footer />
                  ...
                  {this.props.popup.show ? <PopupRatings {...this.props}/> : ""}
