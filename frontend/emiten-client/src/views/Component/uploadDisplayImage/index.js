...
class UploadDisplayImage extends Component{
    ...
    uploadIsSuccess(){
        if(this.props.courses.display.uploadIsSuccess){
            this.props.courses.data.content.displayImage = this.props.courses.display.file;
            ...
            <Col sm="4">
                <div className="card">
                    ...
                    <div className="card-body">
                        <img style={{width: '100%'}} src={`${config.static}/images/${this.props.courses.data.content.displayImage}`} alt="preview-video" />
