	...
	$.fn.stellarNav = function(options, width, breakpoint) {
		...
		return this.each( function() {
			...
			if (settings.position == 'left' || settings.position == 'right') {
				//var closeBtn = '<li><a href="#" class="close-menu ' + cssClass + '"><span class="icon-close"></span></a></li>';
				var closeBtn = '<li><a href="#" class="close-menu ' + cssClass + '"><div class="tutup">&nbsp;</div></a></li>';
			...
			nav.find('li a').each(function() {
				if ($(this).next().length > 0) {
					$(this).parent('li').addClass('has-sub').append('<a class="dd-toggle" href="#"><span class="ti-angle-right"></span></a>');
				}
			});
