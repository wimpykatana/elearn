...
class UploadContentVideoPoster extends Component{
    ...
    handleUpload() {
        ...
        this.props.dispatch(uploadVideoPoster(file, this.props.courses.detail));
    }

    uploadIsSuccess() {
        if(this.props.courses.poster.uploadIsSuccess){
            this.props.courses.detail.imagePreview = this.props.courses.poster.file;
            ...
            <Col sm="4">
               <div className="card">
                    ...
                    <div className="card-body">
                        <img style={{width: '100%'}} src={`${config.static}/images/${this.props.courses.detail.imagePreview}`} alt="preview-video" />
